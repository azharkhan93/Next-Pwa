        ...
        <>
          {testResult.nitrogenRecommendation && (
            <RecommendationCard
              ...
              iconColor="#3b82f6"
              borderColor="#3b82f6"
              title={`Nitrogen (N) - ${testResult.nitrogenRecommendation.level}${testResult.nitrogenRecommendation.increasePercent !== null &&
          ...
          {testResult.phosphorusRecommendation && (
            <RecommendationCard
              ...
              iconColor="#10b981"
              borderColor="#10b981"
              title={`Phosphate (P₂O₅) - ${testResult.phosphorusRecommendation.level}${testResult.phosphorusRecommendation.increasePercent !== null &&
          ...
          {testResult.potassiumRecommendation && (
            <RecommendationCard
              ...
              iconColor="#f59e0b"
              borderColor="#f59e0b"
              title={`Potash (K₂O) - ${testResult.potassiumRecommendation.level}${testResult.potassiumRecommendation.increasePercent !== null &&
